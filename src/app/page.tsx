...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen p-4 sm:p-6 flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 font-[family-name:var(--font-geist-sans)] overflow-x-hidden">
