                          ...
                          <td className="px-6 py-4">
                            {editingId === code.id ? (
                              <input
                                ...
                                className="w-20 px-2 py-1 border border-gray-300 rounded text-center focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none"
                                min="-1"
                                placeholder="-1为无限"
                              />
                            ) : (
        ...
        {activeTab === 'records' && (
          <div className="bg-white rounded-xl shadow-sm">
            <div className="p-6 border-b border-gray-100">
              <h2 className="text-lg font-semibold text-gray-800">激活码生成记录</h2>
                  ...
                  <div key={batch.id} className="p-6 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-3">
                            <span className="font-medium text-gray-800">批次 #{batch.id}</span>
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {JSON.parse(batch.codes).slice(0, 10).map((code: string) => (
                        <span
                          ...
                          className="px-3 py-1 bg-gray-100 rounded text-sm font-mono cursor-pointer hover:bg-gray-200 transition-colors"
                        >
                          {code}
                        </span>
                      ))}
